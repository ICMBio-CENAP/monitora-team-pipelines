...
#----- read data
florestal_fixed_taxonomy <- readRDS(here("01_entrada", "dados_processados", "florestal_fixed_taxonomy.rds"))
...
saveRDS(rn_data_gurupi, here("01_entrada", "dados_processados","rn_data_gurupi.rds"))
saveRDS(rn_data_tdm, here("01_entrada", "dados_processados","rn_data_tdm.rds"))
saveRDS(rn_data_jamari, here("01_entrada", "dados_processados","rn_data_jamari.rds"))
saveRDS(rn_data_juruena, here("01_entrada", "dados_processados","rn_data_juruena.rds"))
saveRDS(rn_data_maraca, here("01_entrada", "dados_processados","rn_data_maraca.rds"))
